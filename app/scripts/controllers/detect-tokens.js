...
const SINGLE_CALL_BALANCES_ADDRESS = '0x2ed7353c7cb306d768dcdc2aa86f74050920b620'
/**
...
export default class DetectTokensController {
  ...
  async detectNewTokens () {
    ...
    try {
      ...
      warn(`SimWallet - DetectTokensController single call balance fetch failed`, error)
      return
    }
