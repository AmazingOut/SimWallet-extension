    ...
    return (
      <div className="metametrics-opt-in">
        <div className="metametrics-opt-in__main">
          ...
          <div className="metametrics-opt-in__title">Help Us Improve SimWallet</div>
          <div className="metametrics-opt-in__body">
            <div className="metametrics-opt-in__description">
            SimWallet would like to gather usage data to better understand how our users interact with the extension. This data
             will be used to continually improve the usability and user experience of our product and the SimpleChain ecosystem.
            </div>
            <div className="metametrics-opt-in__description">
            SimWallet will..
            </div>
            ...
            <div className="metametrics-opt-in__bottom-text">
              { t('gdprMessage', [
                <a
                  ...
                  href="https://SimpleChain.io/privacy.html"
                  target="_blank"
