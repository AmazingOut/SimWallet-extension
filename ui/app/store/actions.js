...
export function updateAndSetCustomRpc (newRpc, chainId, ticker = 'SIPC', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function editRpc (oldRpc, newRpc, chainId, ticker = 'SIPC', nickname, rpcPrefs) {
  return async (dispatch) => {
...
export function setRpcTarget (newRpc, chainId, ticker = 'SIPC', nickname) {
  return async (dispatch) => {
